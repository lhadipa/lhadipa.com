...
const dict = {
  pt: {
    ...
    'feat-seo': 'SEO/GEO e busca por IA',
    'feat-auto': 'Automação com IA e n8n',
    ...
    'now-3': 'SEO e GEO para aparecer no Google e nas buscas por IA',
    'now-4': 'Automações com IA e n8n, com documentação clara',
    'now-5': 'Aberto a qualquer desafio que envolva código',
    'work-kicker': 'trabalho',
    'work-h2': 'Projetos que marcaram o caminho',
    'w-ibgc-desc': 'Site institucional do Instituto Brasileiro de Governança Corporativa, com foco em SEO e GEO — conteúdo estruturado para ser encontrado tanto no Google quanto em buscadores de IA.',
    'w-ibgc-cms-desc': 'CMS headless em Strapi que alimenta o ibgc.org.br: modelagem de conteúdo, API para o front-end e documentação para o time editorial.',
    'w-auto-fin-desc': 'Agente de IA em um harness próprio orquestrado com n8n: faz a triagem de tickets de suporte, classifica, responde os casos simples e escala o resto para o time certo.',
    'w-auto-retail-desc': 'Automações com n8n e LLMs que integram ERP, e-commerce e atendimento — de relatórios diários gerados por IA a respostas de pós-venda —, tudo documentado para o time operar sozinho.',
  ...
  en: {
    ...
    'feat-seo': 'SEO/GEO and AI search',
    'feat-auto': 'AI automation with n8n',
    ...
    'now-3': 'SEO and GEO to show up on Google and in AI search',
    'now-4': 'AI automations with n8n, with clear documentation',
    'now-5': 'Open to any challenge that involves code',
    'work-kicker': 'work',
    'work-h2': 'Projects that shaped the journey',
    'w-ibgc-desc': 'Institutional website for the Brazilian Institute of Corporate Governance, focused on SEO and GEO — structured content built to be found on Google and AI search engines alike.',
    'w-ibgc-cms-desc': 'Headless Strapi CMS powering ibgc.org.br: content modeling, an API for the front-end and documentation for the editorial team.',
    'w-auto-fin-desc': 'AI agent running on a custom harness orchestrated with n8n: triages support tickets, classifies them, answers the simple ones and escalates the rest to the right team.',
    'w-auto-retail-desc': 'n8n + LLM automations connecting ERP, e-commerce and customer service — from AI-generated daily reports to post-sale replies — all documented so the team can run it on their own.',
